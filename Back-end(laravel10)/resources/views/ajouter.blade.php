        ...
        <div class="row s12">
            ...
            <form class="form-group" action="/ajouter/traitement" method="POST">
                ...
                <div class="mb-2">
                  ...
                  <input type="text" class="form-control"  id="numero-visiteur" name="numero_visiteur">
                </div>

                <div class="mb-2">
                    <label for="nom" class="form-label">Nom de visiteur</label>
                    <input type="text" class="form-control"  id="numero-visiteur" name="nom">
                  </div>

                  <div class="mb-2">
                    <label for="nombrejour" class="form-label">Nombre de jour</label>
                    <input type="text" class="form-control"  id="numero-visiteur" name="nombre_jour">
                  </div>

                  <div class="mb-2">
                    <label for="tarif" class="form-label">Tarif journalier</label>
                    <input type="text" class="form-control"  id="numero-visiteur" name="tarif">
                  </div>
                  <br>
                  <br>
                <button type="submit" class="btn btn-primary">Ajouter un visiteur</button>
                  <br> <br> <br> <br>
